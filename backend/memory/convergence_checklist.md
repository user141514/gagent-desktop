...
- default latest-report scoring rejects passed optional E2E ledger_summary values or event sequences that do not match the raw runtime_ledger JSONL for the same run id;
