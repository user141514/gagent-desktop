...
- baseline convergence runner validates and prints the advisory functionality score JSON, including required evidence fields, on success;
...
- functionality score output includes non-secret evidence for input report files, Python executable, results directory, and E2E switches;
