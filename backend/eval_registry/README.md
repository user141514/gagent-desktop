...
Internal eval reports must include every case from `backend/eval_registry/cases/*.json`; missing, unexpected, duplicate case ids, or summary counts/status that do not match the results invalidate the internal eval component.
