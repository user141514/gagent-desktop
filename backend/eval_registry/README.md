...
Internal eval reports must include every case from `backend/eval_registry/cases/*.json`; missing, unexpected, or duplicate case ids invalidate the internal eval component.
